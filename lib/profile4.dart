...
class Profile4 extends StatelessWidget {
  ...
  Profile4({super.key,required email,required password,required search});
        ...
        child: Center(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text('Login Now',style: TextStyle(color: Colors.black87,fontSize:30 ,fontWeight: FontWeight.bold,),),
                Text('Please login to continue usinng our app',style:TextStyle(color: Colors.grey),),
                Container(
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 27,),
                      TextButton(onPressed: (){}, child: Text('Forget password?',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                      ),
                    ],
                  ),
                ),
                ...
                Container(
                  ...
                  child:
                  ElevatedButton(onPressed: (){}, child: Text('Login',style: TextStyle(color: Colors.white,fontSize:25,fontWeight:FontWeight.bold),
                  ),
                    style: ButtonStyle(
